...
Question 3 Loadting Data Load, tidy, and otherwise wrangle the data.
...
weekend variable or weekday variable, and 1440 variables for each minute
of the day that measures activity count. There are 35 observations for
35 days.
...
each activity minute, there was a 1.0 entered. I created a line plot to
better visualize any trends. There is a very large spread on Mondays and
Saturdays, and a very narrow spread on Tuesday, Wednesday, and Thursday.
This might suggest that the activities that this person is doing on
those days are similar, whereas they tend to vary more Friday – Monday.
...
Wednesday has a very low level energy expenditure. We can also see that
Fridays (or whats in purple), has spurts of high energy expenditure.
Because there is so many datapoints, I limited the output to only week 1
to make it easier to read. The output is provided. Here you are able to
see that Wednesay and Tuesday have very low energy expenditure, and
Fridays have very high energy expenditure.
